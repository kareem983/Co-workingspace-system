...
namespace workspace
{
    public partial class Form2 : Form
    {
        ...
        private void textBox5_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider1.SetError(textBox5, " Enter your email !");
            }
        ...
        private void textBox6_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider2.SetError(textBox6, "enter your password");
            }
        ...
        private void textBox7_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(textBox6.Text))
            {
                errorProvider2.SetError(textBox7, "enter your password");
            }
            else if (!Regex.IsMatch(textBox7.Text, textBox6.Text))
            {
                errorProvider3.SetError(textBox7, " please enter the same password  ");
            }
            else
            {
        ...
        private void textBox8_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider4.SetError(textBox8, " enter your phone number!");
            }
        ...
        private void textBox3_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                errorProvider5.SetError(textBox3, " enter your name");
            }
